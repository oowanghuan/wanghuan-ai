          ...
          <div class="module-resources">
            ...
            <button v-if="hasQuiz('part0')" class="resource-btn quiz" @click="openQuiz('part0')">
              ...
              <span class="resource-text">
                ...
                <small>{{ quizQuestions.part0.length }} questions</small>
              </span>
            </button>
          </div>
        </div>
        ...
        <div class="module-card">
          ...
          <div class="module-resources">
            ...
            <button v-if="hasQuiz('part1')" class="resource-btn quiz" @click="openQuiz('part1')">
              ...
              <span class="resource-text">
                <strong>Take Quiz</strong>
                <small>{{ quizQuestions.part1.length }} questions</small>
              </span>
            </button>
          </div>
        </div>
        ...
        <div class="module-card">
          ...
          <div class="module-resources">
            ...
            <button v-if="hasQuiz('part2')" class="resource-btn quiz" @click="openQuiz('part2')">
              ...
              <span class="resource-text">
                <strong>Take Quiz</strong>
                <small>{{ quizQuestions.part2.length }} questions</small>
              </span>
            </button>
          </div>
        </div>
        ...
        <div class="module-card">
          ...
          <div class="module-resources">
            ...
            <button v-if="hasQuiz('part3')" class="resource-btn quiz" @click="openQuiz('part3')">
              ...
              <span class="resource-text">
                <strong>Take Quiz</strong>
                <small>{{ quizQuestions.part3.length }} questions</small>
              </span>
            </button>
          </div>
        </div>
    ...
    <section class="related-section">
      <div class="container container-md">
        ...
        <div class="related-grid">
          ...
          <a href="https://github.com/oowanghuan/ai-coding-template" target="_blank" class="related-card">
...
const audioUrls = reactive({
  part0: `${R2_BASE}/Part_0_Treat_AI_Like_a_Super_New_Colleague.m4a`,
  part1: `${R2_BASE}/Part_1_Master_the_AI_Commander_Mindset.m4a`,
  part2: `${R2_BASE}/Part_2_Your_Phantom_Promotion_to_AI_Commander.m4a`,
  part3: `${R2_BASE}/Part_3_-_The_6-Step_Standard_AI_Work_Cycle.m4a`,
})

const pdfUrls = reactive({
  part0: `${R2_BASE}/Part%200%20AI_Workflow_Business_Vocabulary.pdf`,
  part1: `${R2_BASE}/Part%201%20From_Executor_to_Commander.pdf`,
